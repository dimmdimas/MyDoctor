    ...
    return (
        <View style={styles.page}>
            ...
            <View style={styles.content}>
                ...
                <ListHospital pic={DummyHospital2} type="Rumah Sakit Anak" name="Happy Family Kids" address="Jln. Surya Sejahtera 32" />
                <ListHospital pic={DummyHospital3} type="Rumah Sakit Jiwa" name="Tingkatan Paling Atas" address="Jln. Surya Sejahtera 21" />
            </View>
        </View>
    )
}
